<template>
    <form id="contact-me" class="w-full mx-auto max-w-3xl bg-gray-500 shadow p-8 text-gray-700 ">
    <h2 class="w-full my-2 text-3xl font-bold leading-tight my-5">Bewerben</h2>
    <!-- name field -->
